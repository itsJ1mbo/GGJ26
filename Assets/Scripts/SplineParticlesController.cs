...
public class SplineParticlesController : MonoBehaviour
{
    ...
    private IEnumerator StartParticles()
    {
        ...
        {
            // Activamos la part�cula actual
            // Asumo que SplineFollowerParticle tiene un m�todo o puedes activar su GameObject
            particles[currentIndex].gameObject.SetActive(true);

            // Si el componente tiene un m�todo para empezar el movimiento, ll�malo aqu�:
